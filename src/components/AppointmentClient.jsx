    ...
    <div className="bg-linear-to-br from-sky-100/90 via-emerald-50/70 to-green-50/40">
      ...
      <div className="text-center py-10">
        ...
        <p className="text-xl md:text-4xl font-medium">
          Find and book appointments with top-rated medical specialists
          across the country.
        </p>
        ...
        <div className="mt-8 px-5">
          <input
            ...
            className="w-full max-w-xl p-4 border border-gray-300 rounded-xl bg-white outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
